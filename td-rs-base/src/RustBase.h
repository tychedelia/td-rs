...
uint64_t
getDownloadDataSize(TD::OP_SmartRef<TD::OP_TOPDownloadResult> &result) {
...
TD::OP_TextureDesc
getDownloadTextureDesc(TD::OP_SmartRef<TD::OP_TOPDownloadResult> &result) {
...
TD::OP_TextureDesc
getCUDAArrayInfoTextureDesc(const TD::OP_CUDAArrayInfo &info) {
