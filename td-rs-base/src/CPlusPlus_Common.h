...
public:
  ...
  SOP_PrimitiveInfo getPrimitive(int32_t primIndex) const {
...
public:
  ...
  virtual void *
  getTOPDataInCPUMemory(const OP_TOPInput *top,
...
static_assert(offsetof(OP_TOPInputDownloadOptions, downloadType) == 0,
              "Incorrect Alignment");
static_assert(offsetof(OP_TOPInputDownloadOptions, verticalFlip) == 4,
              "Incorrect Alignment");
static_assert(offsetof(OP_TOPInputDownloadOptions, cpuMemPixelType) == 8,
              "Incorrect Alignment");
