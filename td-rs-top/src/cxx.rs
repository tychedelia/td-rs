...
include_cpp! {
    ...
    extern_cpp_type!("TD::OP_ColorSpace", td_rs_base::cxx::OP_ColorSpace)
    pod!("TD::OP_ColorSpace")
    extern_cpp_type!("TD::OP_ReferenceWhite", td_rs_base::cxx::OP_ReferenceWhite)
    pod!("TD::OP_ReferenceWhite")
