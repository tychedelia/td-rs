...
enum class TOP_ExecuteMode : int32_t {
  ...
  // to access pixel (x,y) you would need to offset the memory location by
  // bytesperpixel * ( y * width + x). all pixels should be set, pixels that was
  // not set will have an undefined value.

  // "CPUMemWriteOnly" - cpuPixelData* will be provided that you fill in with
  // pixel data. This will automatically be uploaded to the GPU as a texture for
  // you. Reading from the memory will result in very poor performance.
  CPUMemWriteOnly,

  // "CPUmemReadWrite - same as CPU_MEM_WRITEONLY but reading from the memory
  // won't result in a large performance pentalty. The initial contents of the
  // memory is undefined still.
  CPUMemReadWrite,
...
public:
  ...
  // uploading from a memory location will invalidate it and a new memory
  // location will be provided next execute call. setting this to -1 will not
  // upload any memory and retain previously uploaded texture setting this to
  // any other value will result in an error being displayed in the CPlusPlus
  // TOP. defaults to -1
  ...
  // The indices for the renderBuffers for the color buffers that are attached
  // to the FBO, except for possibly index 0 (see colorBuffer0Type) these are
  // all GL_RENDERBUFFER GL objects, or 0 if not present
...
public:
  ...
  // "BGRA8Fixed" - each pixel will hold 4 fixed-point values of size 8 bits
  // (use 'unsigned char' in the code). They will be ordered BGRA. This is the
  // preferred ordering for better performance. "RGBA8Fixed" - each pixel will
  // hold 4 fixed-point values of size 8 bits (use 'unsigned char' in the code).
  // They will be ordered RGBA "RGBA32Float" - each pixel will hold 4
  // floating-point values of size 32 bits (use 'float' in the code). They will
  // be ordered RGBA
  //
...
public:
  ...
  virtual bool getOutputFormat(TOP_OutputFormat *, const OP_Inputs *,
                               void *reserved1) {
    return false;
  }
  ...
  virtual void execute(TOP_OutputFormatSpecs *, const OP_Inputs *,
                       TOP_Context *context, void *reserved1) = 0;
...
static_assert(offsetof(TOP_OutputFormatSpecs, width) == 0,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, height) == 4,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, aspectX) == 8,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, aspectY) == 12,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, antiAlias) == 16,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, redBits) == 20,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, blueBits) == 24,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, greenBits) == 28,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, alphaBits) == 32,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, floatPrecision) == 36,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, numColorBuffers) == 40,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, depthBits) == 44,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, stencilBits) == 48,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, pixelFormat) == 52,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, cpuPixelData) == 56,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, newCPUPixelDataLocation) == 80,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, colorBuffer0Type) == 84,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, colorBufferRB) == 88,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, depthBufferRB) == 216,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormatSpecs, cudaOutput) == 224,
              "Incorrect Aligment");
static_assert(sizeof(TOP_OutputFormatSpecs) == 520, "Incorrect Size");

static_assert(offsetof(TOP_GeneralInfo, cookEveryFrame) == 0,
              "Incorrect Aligment");
static_assert(offsetof(TOP_GeneralInfo, clearBuffers) == 1,
              "Incorrect Aligment");
static_assert(offsetof(TOP_GeneralInfo, mipmapAllTOPs) == 2,
              "Incorrect Aligment");
static_assert(offsetof(TOP_GeneralInfo, cookEveryFrameIfAsked) == 3,
              "Incorrect Aligment");
static_assert(offsetof(TOP_GeneralInfo, inputSizeIndex) == 4,
              "Incorrect Aligment");
static_assert(offsetof(TOP_GeneralInfo, reservedForLegacy1) == 8,
              "Incorrect Aligment");
static_assert(offsetof(TOP_GeneralInfo, memPixelType) == 12,
              "Incorrect Aligment");
...
static_assert(offsetof(TOP_OutputFormat, antiAlias) == 16,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, redChannel) == 20,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, greenChannel) == 21,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, blueChannel) == 22,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, alphaChannel) == 23,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, bitsPerChannel) == 24,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, floatPrecision) == 28,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, numColorBuffers) == 32,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, depthBits) == 36,
              "Incorrect Aligment");
static_assert(offsetof(TOP_OutputFormat, stencilBits) == 40,
              "Incorrect Aligment");
