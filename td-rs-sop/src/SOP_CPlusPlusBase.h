...
public:
	...
	// Override these methods if you want to output values to the Info sop/DAT
	// returning 0 means you dont plan to output any Info sop channels
	virtual int32_t
	getNumInfosopChans(void *reserved1)
	{
		return 0;
	}

	// Specify the name and value for sop 'index',
	// by assigning something to 'name' and 'value' members of the
	// OP_InfosopChan class pointer that is passed (it points
	...
	// to it.
	virtual void
	getInfosopChan(int32_t index, OP_InfosopChan* chan, void *reserved1)
	{
	}
	...
	// Set the members of the sop_InfoDATSize class to specify
