...
public:
  ...
  // TouchDesigner is running at 60 hz cookrate, and you missed a frame last
  // cook then on this cook the number of sampels of the output of this CHOP
  // will be 4 samples. I.e (120 / 60) * number of playbar frames to output. If
  // this isn't set then you specify the number of sample in the CHOP using the
  // getOutputInfo() function DEFAULT: false
  bool timeslice;
...
class CHOP_Output {
public:
  CHOP_Output(int32_t nc, int32_t l, float s, uint32_t st, float **cs,
              const char **ns)
      : numChannels(nc), numSamples(l), sampleRate(s), startIndex(st),
        channels(cs), names(ns) {}
...
public:
  ...
  virtual void getGeneralInfo(CHOP_GeneralInfo *, const OP_Inputs *inputs,
                              void *reserved1) {}
  ...
  virtual bool getOutputInfo(CHOP_OutputInfo *, const OP_Inputs *inputs,
                             void *reserved1) {
    return false;
  }
...
static_assert(offsetof(CHOP_PluginInfo, apiVersion) == 0,
              "Incorrect Alignment");
static_assert(offsetof(CHOP_PluginInfo, customOPInfo) == 408,
              "Incorrect Alignment");
static_assert(sizeof(CHOP_PluginInfo) == 944, "Incorrect Size");

static_assert(offsetof(CHOP_GeneralInfo, cookEveryFrame) == 0,
              "Incorrect Alignment");
static_assert(offsetof(CHOP_GeneralInfo, cookEveryFrameIfAsked) == 1,
              "Incorrect Alignment");
static_assert(offsetof(CHOP_GeneralInfo, timeslice) == 2,
              "Incorrect Alignment");
static_assert(offsetof(CHOP_GeneralInfo, inputMatchIndex) == 4,
              "Incorrect Alignment");
static_assert(sizeof(CHOP_GeneralInfo) == 88, "Incorrect Size");

static_assert(offsetof(CHOP_OutputInfo, numChannels) == 0,
              "Incorrect Alignment");
static_assert(offsetof(CHOP_OutputInfo, numSamples) == 4,
              "Incorrect Alignment");
static_assert(offsetof(CHOP_OutputInfo, startIndex) == 8,
              "Incorrect Alignment");
static_assert(offsetof(CHOP_OutputInfo, sampleRate) == 12,
              "Incorrect Alignment");
static_assert(offsetof(CHOP_OutputInfo, reserved1) == 16,
              "Incorrect Alignment");
