...
public:
    ...
    bool getOutputInfo(ChopOutputInfo* info, td_rs_base::ffi::OperatorInput* input) noexcept;
    int32_t getNumInfoChopChans() noexcept;
    ChopInfoChan getInfoChopChan(int32_t index) noexcept;
    rust::String getChannelName(int32_t index, td_rs_base::ffi::OperatorInput* input) noexcept;
    ...
    void execute(ChopOutput* output, td_rs_base::ffi::OperatorInput* input) noexcept;
